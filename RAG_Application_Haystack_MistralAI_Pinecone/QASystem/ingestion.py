...
def ingest(document_store):
	...
	indexing.run({"converter": {"sources": [Path("C:\\Users\\ganes\\DataScience\\Gen_AI\\LangChain\\Course_GenAI\\Gen_AI_In-Depth\\Projects\\RAG_Application_Haystack_MistralAI_Pinecone\\Data\\Retrieval-Augmented-Generation-for-NLP.pdf")]}})
